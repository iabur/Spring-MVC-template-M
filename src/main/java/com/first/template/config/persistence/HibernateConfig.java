package com.first.template.config.persistence;
...
@EnableJpaRepositories("com.first.template.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.first.template.model");
                for (Class<?> clazz : (new Reflections("com.first.template.model")).getTypesAnnotatedWith(Entity.class)) {
